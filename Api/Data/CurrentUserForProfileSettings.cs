...
{
    public sealed class CurrentUserForProfileSettings
    {
        /// <summary>
        /// Enabled features
        /// </summary>
        ...
        [Required(AllowEmptyStrings = true)]
        [JsonConverter(typeof(CustomStringEnumConverter<CurrentUserForProfileSettingsRole>))]
        public CurrentUserForProfileSettingsRole Role { get; set; } = default!;
        /// <summary>
